...
public class MinefornowApplication {
    ...
    @Bean
    @Profile("!test")
    public CommandLineRunner demo(VehicleRepository vehicleRepo, BookingRepository bookingRepo, UserRepository userRepo) {
        return (args) -> {
            // --- CRIAR USERS ---
            ...
            User renter = userRepo.save(User.builder()
